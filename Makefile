all: build/index.html build/2020/index.html build/styles/flossevents.css build/img/europe-wo-borders-250a.jpg build/img/logo.png build/img/fossevents_512.png build/img/fossevents_1024.png build/favicon.ico
